...
public class InteractionTest {
	...
	public static void main(String[] args) throws Exception {
		...
		// 读取文件，取得Document
		Document document = reader.read(new FileInputStream("D:/bizcode_20170123172330/bizcode_20170123172330.xml"));
		// 取得根标签对象，得到books的标签
			...
			public void run() {
				try {
					...
					for (Element element : elements) {
						...
						long lOnlinetime = simpleDateFormat.parse(onlinetime).getTime();
						...
						long lOfflineTime = simpleDateFormat.parse(offlineTime).getTime();
